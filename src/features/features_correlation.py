...
def calculcate_feature_correlation( home_feature_column_name, away_feature_column_name, k, min_week_game, date_min, dataset_0):
    ...
    #Pour se faire une utilise les quartiless
...
def feature_correlation_with_results_analysis(dataset_0, home_feature_column_name, away_feature_column_name, k, min_week_game, date_min):    
    
    correlation, p_value, mean_ra1, mean_ra0, df_without_outliers_0 = calculcate_feature_correlation(dataset_0, home_feature_column_name, away_feature_column_name, k, min_week_game, date_min)
    
    # Affichage des résultats
    print(f"Corrélation de point bisérial : {correlation}")
